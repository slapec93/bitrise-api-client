...
type ClientService interface {
	BuildCertificateConfirm(params *BuildCertificateConfirmParams, authInfo runtime.ClientAuthInfoWriter) (*BuildCertificateConfirmOK, error)

	BuildCertificateCreate(params *BuildCertificateCreateParams, authInfo runtime.ClientAuthInfoWriter) (*BuildCertificateCreateCreated, error)

	BuildCertificateDelete(params *BuildCertificateDeleteParams, authInfo runtime.ClientAuthInfoWriter) (*BuildCertificateDeleteOK, error)

	BuildCertificateList(params *BuildCertificateListParams, authInfo runtime.ClientAuthInfoWriter) (*BuildCertificateListOK, error)

	BuildCertificateShow(params *BuildCertificateShowParams, authInfo runtime.ClientAuthInfoWriter) (*BuildCertificateShowOK, error)

	BuildCertificateUpdate(params *BuildCertificateUpdateParams, authInfo runtime.ClientAuthInfoWriter) (*BuildCertificateUpdateOK, error)
