...
func (m *V0ArtifactListResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0ArtifactListResponseModel) validatePaging(formats strfmt.Registry) error {
...
func (m *V0ArtifactListResponseModel) UnmarshalBinary(b []byte) error {
	var res V0ArtifactListResponseModel
