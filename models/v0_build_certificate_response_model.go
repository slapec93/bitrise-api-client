...
func (m *V0BuildCertificateResponseModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V0BuildCertificateResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0BuildCertificateResponseModel) UnmarshalBinary(b []byte) error {
	var res V0BuildCertificateResponseModel
