...
func (m *V0BuildRequestListResponseModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V0BuildRequestListResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0BuildRequestListResponseModel) UnmarshalBinary(b []byte) error {
	var res V0BuildRequestListResponseModel
